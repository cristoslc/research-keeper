---
source-id: "dev-to-git-repo-knowledge-base"
...
hash: "4ea0e9f325419cdb8bf8baebfe94df1f45f025b11598c899c4f8b6e226d9ecb4"
---

# A Personal Git Repo as a Knowledge Base Wiki

By Adam Braimah, Posted on Feb 19, 2021
...
I now have copies of my own repo on a Windows desktop, Mac laptop, and a USB flash drive, as well as on Bitbucket. A quick `git pull` on each grabs the latest changes as needed, and after that the notes are available even if there is no network available. I'll be continually adding to it and think that this is a solid way of preserving the jewels picked up along my development journey.

## Notable Comments

- Obsidian was recommended as a tool that works well with markdown repos, though it doesn't recognize `.markdown` file extensions.
- Foam (a VSCode plugin) was suggested for linking content within markdown-based knowledge bases.
- MDwiki was noted as no longer maintained and may have issues with newer browsers.
- Python's built-in `python3 -m http.server` was suggested as a minimal way to serve the wiki locally.
