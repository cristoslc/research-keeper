---
source-id: "decap-cms-git-based-cms-guide"
title: "Git-Based CMS: Definition, Features, Best Practices | Decap CMS"
type: web
url: "https://decapcms.org/blog/git-based-cms-definition-features-best-practices/"
fetched: 2026-03-30T18:04:37Z
hash: "d4627af6c6f466f37c3c5cacb201afabab39e9a2a083a44b8399debdc98cb1de"
---

# Git-Based CMS: Definition, Features, Best Practices
...
A Git-based CMS, as the name suggests, enables you to edit content that is stored in your Git repository, alongside your code. It's an integral part of the Jamstack architecture, which separates the frontend from data and business logic. In practice, this means you'll need:
...
To mitigate this, some Git-based CMS platforms like Tina and CloudCannon offer a cloud database proxy, enabling advanced features that might be necessary for specific projects. Those could be real-time collaboration, user roles, and other resource-intensive queries.
...
Moreover, Git is not ideal for storing large files like images efficiently. Although Git offers a feature known as Large File Storage (LFS), it's often more practical to use an external service such as Cloudinary or Uploadcare to manage large assets. These services, called digital asset managers (DAM), can be seamlessly integrated into your Git-based CMS, providing a more efficient way to handle media files.
